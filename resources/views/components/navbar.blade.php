<div class="w-1/20 h-full flex flex-col justify-between items-center py-5 bg-black">
    <div class="w-full h-full flex flex-col items-center gap-8">
        ...
        <div class="w-full h-fit flex flex-col items-center gap-4">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="white" class="bi bi-bookmarks" viewBox="0 0 16 16">
    ...
    <div class="w-full h-fit flex flex-col items-center gap-4">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="white" class="bi bi-door-open" viewBox="0 0 16 16">
